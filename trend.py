...
def plot_metric(ax, metric, league_avg, moving_avg_5, moving_avg_10, moving_avg_20):
    sns.lineplot(data=league_avg, x='Season', y=metric, ax=ax, marker='o', label='리그 평균', fontproperties=fontprop)
    sns.lineplot(data=moving_avg_5, x='Season', y=metric, ax=ax, linestyle='--', color='gray', label='5개년 이동평균', fontproperties=fontprop)
    sns.lineplot(data=moving_avg_10, x='Season', y=metric, ax=ax, linestyle='-.', color='blue', label='10개년 이동평균', fontproperties=fontprop)
    sns.lineplot(data=moving_avg_20, x='Season', y=metric, ax=ax, linestyle=':', color='red', label='20개년 이동평균', fontproperties=fontprop)
