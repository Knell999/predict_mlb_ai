...
AGENT_LLM_MAX_TOKENS = 8000
AGENT_ROUTER_TEMPERATURE = 0.0
AGENT_RECURSION_LIMIT = 25
CHAT_MAX_HISTORY = 20
PREDICTION_MIN_SEASONS = 3
QUALITY_Z_SCORE_THRESHOLD = 3.0
QUALITY_MAX_ANOMALIES_TO_INTERPRET = 20
SIMILARITY_DEFAULT_TOP_N = 10
SIMILARITY_DEFAULT_BATTER_METRICS = [
    'BattingAverage', 'OnBasePercentage', 'SluggingPercentage',
    'OPS', 'HomeRuns', 'RBIs'
]
SIMILARITY_DEFAULT_PITCHER_METRICS = [
    'EarnedRunAverage', 'Whip', 'StrikeOuts', 'InningsPitched', 'Wins'
]
